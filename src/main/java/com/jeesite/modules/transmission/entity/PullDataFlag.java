 ...
 *
 */
@Table(name = "trans_pull_data_flag", columns = { @Column(name = "id", attrName = "id", label = "主键", isPK = true),
		@Column(name = "app_uri", attrName = "appUri", label = "应用唯一标识"),
		@Column(name = "bus_type", attrName = "busType", label = "业务类型"),
		@Column(name = "rows_json_str", attrName = "rowsJsonStr", label = "待拉取的数据") })
